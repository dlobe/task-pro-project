...
import { setToken, updateWorkstream } from '../service';
    ...
    constructor(props) {
      ...
      mySubmitHandler = (event) => {
        ...
        if(ok===0)
        {
            try {
                setToken();
                updateWorkstream(this.rowData.Id, {Name:name, Status:Status, Priority: Priority, Blocked: Blocked});
        ...
        return (
            <div className="margin">
                <form  onSubmit={this.mySubmitHandler}>
                    ...
                    <TextField id="Priority" name="Priority" value={this.state.Priority} fullWidth className="mb" label="Priority" onChange={this.myChangeHandler} variant="outlined" error={this.state.err_w} helperText={this.state.err_Priority} />
                    <TextField id="Status" name="Status" value={this.state.Status} fullWidth className="mb" label="Status" onChange={this.myChangeHandler} variant="outlined" error={this.state.err_a} helperText={this.state.err_Status} />
                    <FormControlLabel 
                                value="start" 
