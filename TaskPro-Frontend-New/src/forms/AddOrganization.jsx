...
import { setToken, addOrgs } from '../service';
    ...
    constructor(props) {
      ...
      mySubmitHandler = (event) => {
        ...
        if(ok===0)
        {
            try {
                setToken();
                addOrgs({Name:name, Address:address, Website: website});
        ...
        return (
            <div className="margin">
                <form  onSubmit={this.mySubmitHandler}>
                    ...
                    <TextField id="website" name="website" fullWidth className="mb" label="Website" onChange={this.myChangeHandler} variant="outlined" error={this.state.err_w} helperText={this.state.err_website} />
                    <TextField id="address" name="address" fullWidth className="mb" label="Postal Addres" onChange={this.myChangeHandler} variant="outlined" error={this.state.err_a} helperText={this.state.err_address} />
                    <div className="margin">
